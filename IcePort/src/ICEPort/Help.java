...
public class Help extends JDialog{
	...
	public Help()  throws MalformedURLException {
		...
		JDialog dialog = new JDialog((ICEFrame) null,"Help Dialog" );
		...
		tabbedPane.setTabPlacement(JTabbedPane.NORTH_EAST);
...
JButton b3= new JButton("<html>**AS FOR THE SENDER**<br> You can send file to your friend by clicking<br>at" +
		" your friends ICE-tizen<br>,then the window to select file<br>will popup on the screen<br><br>**AS FOR " +
